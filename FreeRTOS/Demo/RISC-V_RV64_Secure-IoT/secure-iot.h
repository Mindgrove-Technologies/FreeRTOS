/*
* @headerfile secure-iot.h - Header File for Secure-IoT C-Class SoC for FPGA
...
#define PWM_END_ADDRESS 0x00030080 /*PWM End address*/

#define PWM_BASE0_CONTROL_ADDRESS 0x00030004
#define PWM_BASE0_PERIOD_ADDRESS 0x00030008
#define PWM_BASE0_DUTY_CYCLE_ADDRESS 0x0003000C
#define PWM_BASE0_DEADBAND_DELAY_ADDRESS 0x00030010

#define PWM_BASE1_CONTROL_ADDRESS 0x00030014
#define PWM_BASE1_PERIOD_ADDRESS 0x00030018
#define PWM_BASE1_DUTY_CYCLE_ADDRESS 0x0003001C
#define PWM_BASE1_DEADBAND_DELAY_ADDRESS 0x00030020

#define PWM_BASE2_CONTROL_ADDRESS 0x00030024
#define PWM_BASE2_PERIOD_ADDRESS 0x00030028
#define PWM_BASE2_DUTY_CYCLE_ADDRESS 0x0003002C
#define PWM_BASE2_DEADBAND_DELAY_ADDRESS 0x00030030

#define PWM_BASE3_CONTROL_ADDRESS 0x00030034
#define PWM_BASE3_PERIOD_ADDRESS 0x00030038
#define PWM_BASE3_DUTY_CYCLE_ADDRESS 0x0003003C
#define PWM_BASE3_DEADBAND_DELAY_ADDRESS 0x00030040

#define PWM_BASE4_CONTROL_ADDRESS 0x00030044
#define PWM_BASE4_PERIOD_ADDRESS 0x00030048
#define PWM_BASE4_DUTY_CYCLE_ADDRESS 0x0003004C
#define PWM_BASE4_DEADBAND_DELAY_ADDRESS 0x00030050

#define PWM_BASE5_CONTROL_ADDRESS 0x00030054
#define PWM_BASE5_PERIOD_ADDRESS 0x00030058
#define PWM_BASE5_DUTY_CYCLE_ADDRESS 0x0003005C
#define PWM_BASE5_DEADBAND_DELAY_ADDRESS 0x00030060

#define PWM_BASE6_CONTROL_ADDRESS 0x00030064
#define PWM_BASE6_PERIOD_ADDRESS 0x00030068
#define PWM_BASE6_DUTY_CYCLE_ADDRESS 0x0003006C
#define PWM_BASE6_DEADBAND_DELAY_ADDRESS 0x00030070

#define PWM_BASE7_CONTROL_ADDRESS 0x00030074
#define PWM_BASE7_PERIOD_ADDRESS 0x00030078
#define PWM_BASE7_DUTY_CYCLE_ADDRESS 0x0003007C
#define PWM_BASE7_DEADBAND_DELAY_ADDRESS 0x00030080
...
#define QSPI_BASE_ADDRESS  0x00040000 /*! Standard Quad Serial Peripheral Interface Base address*/
#define QSPI_END_ADDRESS  0x000400FF /*! Standard Quad Serial Peripheral Interface Base address*/
...
#define PWM_INTERRUPT_0       33  /* PWM 0 */
#define PWM_INTERRUPT_1       34  /* PWM 1 */
#define PWM_INTERRUPT_2       35  /* PWM 2 */
#define PWM_INTERRUPT_3       36  /* PWM 3 */
#define PWM_INTERRUPT_4       37  /* PWM 4 */
#define PWM_INTERRUPT_5       38  /* PWM 5 */
#define PWM_INTERRUPT_6       39  /* PWM 6 */
#define PWM_INTERRUPT_7       40  /* PWM 7 */
#define I2C_INTERRUPT_0       41  /* I2C 0 */
#define I2C_INTERRUPT_1       42  /* I2C 1 */
#define UART_INTERRUPT_0      43  /* UART 0 */
#define UART_INTERRUPT_1      44  /* UART 1 */
#define UART_INTERRUPT_2      45  /* UART 2 */
#define ADC_INTERRUPT_0       46  /* ADC 0 */
#define QSPI_INTERRUPT_TOF_0  47  /* QSPI_TOF 0 */
#define QSPI_INTERRUPT_SMF_0  48  /* QSPI_SMF 0 */
#define QSPI_INTERRUPT_TH_0   49  /* QSPI_TH  0 */
#define QSPI_INTERRUPT_TCF_0  50  /* QSPI_TCF 0 */
#define QSPI_INTERRUPT_TEF_0  51  /* QSPI_TEF 0 */
#define QSPI_INTERRUPT_REQ_0  52  /* QSPI_REQ 0 */
#define QSPI_INTERRUPT_TOF_1  53  /* QSPI_TOF 1 */
#define QSPI_INTERRUPT_SMF_1  54  /* QSPI_SMF 1 */
#define QSPI_INTERRUPT_TH_1   55  /* QSPI_TH  1 */
#define QSPI_INTERRUPT_TCF_1  56  /* QSPI_TCF 1 */
#define QSPI_INTERRUPT_TEF_1  57  /* QSPI_TEF 1 */
#define QSPI_INTERRUPT_REQ_1  58  /* QSPI_REQ 1 */
#define SPI_INTERRUPT_0       59  /* SPI 0 */
#define SPI_INTERRUPT_1       60  /* SPI 1 */
#define SPI_INTERRUPT_2       61  /* SPI 2 */
#define SPI_INTERRUPT_3       62  /* SPI 3 */
#define PLIC_MAX_INTERRUPT_SRC 62
