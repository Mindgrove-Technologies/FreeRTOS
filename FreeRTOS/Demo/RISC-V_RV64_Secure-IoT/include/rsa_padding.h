 ...
 * @param salt_length Length of the salt in bytes. When use_provided_salt = 1,
 *                    this is the length of the provided salt. When 
 *                    use_provided_salt = 0, this is the number of random
 *                    bytes generated internally (default: 32 bytes).
