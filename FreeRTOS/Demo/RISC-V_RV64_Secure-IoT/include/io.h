 ...
 * 
 * @param buffer Pointer to the string buffer where the formatted string is stored.
 * @param format C string that contains a format string.
 * @param ... Additional arguments specifying data to be printed.
 * 
 * @return The total number of characters written, not including the null-terminator.
 */
