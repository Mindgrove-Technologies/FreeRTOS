 ...
 *
 * @param interrupt_en The paramter \a interrupt_en is used as a bool to enable the interrupt
 * 
 ...
 * 
 */
void gptInit(int gpt_num, int mode, int interrupt_en, int period, int prescalar, int dutycycle, int cnt_en, int capture_val, int output_en);
/**
